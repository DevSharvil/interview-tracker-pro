    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">Sign in to your Interview Tracker</p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl shadow-slate-200/60 border border-white/60 p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-slate-200
              bg-white hover:bg-slate-50 text-slate-700 text-sm font-medium transition-all duration-200
